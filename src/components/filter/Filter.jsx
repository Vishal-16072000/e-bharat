                ...
                <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
                    ...
                    <div className="relative">
                        ...
                        onChange={(e) => setSearchKey(e.target.value)}
                            ...
                            className="px-8 py-3 w-full rounded-md bg-violet-0 border-transparent outline-0 text-sm bg-white" style={{ backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', color: mode === 'dark' ? 'white' : '', }} />
                    </div>
                    <div className="flex items-center justify-between mt-4">
                        <p className="font-medium">
                            Filters
                        </p>
                        <button onClick={() =>{setFilterPrice(''); setFilterType(''); setSearchKey('');}} className="cursor-pointer px-4 py-2 bg-gray-50hover:bg-gray-200 text-gray-800 text-sm font-medium rounded-md" style={{ color: mode === 'dark' ? 'white' : '' }}>
                            Reset Filter
                        </button>
                    </div>
                    <div>
